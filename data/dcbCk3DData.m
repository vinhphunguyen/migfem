...
fileName = '~/code/jive/bezier/delamination/dcb3d/dcb3d.mesh';
...
vtuFileName = '../results/dcb3d';
resultFile = '~/code/jive/bezier/delamination/dcb3d/dcb3d.dat';
...
for it=1:noStep
    ...
    U    = disp(:,2:end);
    ok   = writeVTKForJive3D(mesh,vMesh,vtuFile,U,damage,D);
end
