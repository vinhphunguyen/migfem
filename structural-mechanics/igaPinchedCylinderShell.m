...
% uncomment the following line for free ends boundary condition
% nodesOnAB = [];
...
plotMeshSurface (controlPts,weights,uKnot,vKnot,p,q,100,'b-','try.eps');
hold on
%nrbkntplot (solid)
nrbctrlplot(solid)
view(3)
...
%xConsNodes = [xConsNodes noCtrPts-noPtsX+1];
...
% The exact value is: 1.8248e-5
% The exact value is: 4.52e-4 (free ends condition)
...
outfileVTU  = '../results/pinchedCylinderShell.vtu';
