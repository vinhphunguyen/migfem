...
global Q W rho De noDofs noCtrPts Ke0 Me0 damping
...
M    = zeros(noDofs,noDofs); % element Ke
...
for e=1:noElems
    ...
    for gp=1:size(W,1)
        ...
        K(sctrB,sctrB) = K(sctrB,sctrB) + B' * De * B * J * wt;
        M(sctrB,sctrB) = M(sctrB,sctrB) + N' * N * rho * J * wt;
    end
