% Data for the pinched cylinder geometrically nonlinear problem
% 2 quadratic NURBS elements for thickness direction
% Other directions: k-refinement using the NURBS toolbox
% Vinh Phu Nguyen, March 2013
% Cardiff University of Technology

addpath ../nurbs-geopdes/inst/
addpath ../post-processing/
addpath ../

R0     = 4.953;  % mid surface thickness
L      = 10.35/2; % half length
t      = 0.094;
R      = R0 + t/2;
Ri     = R0 - t/2;
Rii    = R0;
