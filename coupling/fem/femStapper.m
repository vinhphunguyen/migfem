...
forceNodes = unique(mesh.LINES(ngr2,1:2)); % nodes
...
if (computeStr)
    ...
    VTKPostProcess(node,element,3,'Tri3','femStapper',...
        [sigmaXX sigmaYY sigmaZZ],[U(xs) U(ys) U(xs)]);
