...
udofs=3*fixedNode-2;   % global indecies of the fixed x displacements
vdofs=3*fixedNode-1;   % global indecies of the fixed y displacements
wdofs=3*fixedNode-0;   % global indecies of the fixed rotations
