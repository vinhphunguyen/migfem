...
% 3 June 2013
% 20 July 2013
% 10 August 2013: try different boundary conditions
...
fxn = intersect(fixedNode,midNode1);

unodes = [fixedNode(1); fxn; fixedNode(end)];
vnodes = [fxn];

udofs=2*unodes-1;           % global indecies of the fixed x displacements
vdofs=2*vnodes;             % global indecies of the fixed y displacements


uFixed=zeros(1,length(udofs))';  % a vector of u_x for the nodes
