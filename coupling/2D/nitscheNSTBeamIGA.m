...
controlPts(1:2,2,1) = [16;-c];
controlPts(1:2,1,2) = [0;c];
controlPts(1:2,2,2) = [16;c];
...
controlPts(1:2,1,1) = [16;-c];
controlPts(1:2,2,1) = [L;-c];
controlPts(1:2,1,2) = [16;c];
...
bndNodes  = find(mesh1.controlPts(:,1)==16);
...
vtuFileName = '../results/iga-nitsche-tbeam';
for ip=1:2
