...
%
% Two patches can be arbitrarily parametrised.
%
% Vinh Phu Nguyen
...
controlPts(1:3,1,2,1) = [0;w1;0];
controlPts(1:3,2,2,1) = [L1;w1;0];

controlPts(1:3,1,1,2) = [0;0;t1];
controlPts(1:3,2,1,2) = [L1;0;t1];
controlPts(1:3,1,2,2) = [0;w1;t1];
controlPts(1:3,2,2,2) = [L1;w1;t1];
...
controlPts(1:3,1,2,1) = [L1;w2;0];
controlPts(1:3,2,2,1) = [L;w2;0];

controlPts(1:3,1,1,2) = [L1;0;t2];
controlPts(1:3,2,1,2) = [L;0;t2];
controlPts(1:3,1,2,2) = [L1;w2;t2];
controlPts(1:3,2,2,2) = [L;w2;t2];
