...
vtkFileName  = 'mpm2DHollowDisksNeoHookean';
vtkFileName1  = '../results/mpm2DHollowDisksNeoHookeanGrid';
...
tol   = 4e-11; % mass tolerance

dtimeLim = deltax/sqrt(E/rho);
