...
global uKnot vKnot noDofs levelSets split_nodes spit_elem noGPs1 jDomainFac
...
%         J1       = norm (jacob1);
%         
%         [sigmaxx,sigmayy,sigmaxy] = exact_Griffith_stress(x,E0,nu0,...
%            sigmato,xTip,seg,cracklength);
%         
%         tx = -sigmaxx;
%         ty = -sigmaxy;
...
vtuFile      = 'infinieCrackModeII';
vtuCrackFile = 'infinieCrackModeII-cracked';
...
title('Sigma_{xy}')
axis off
plot_mesh(node+fac*[dispX dispY],elementV,'Q4','g.-',1);
...
vtuFile = 'infiniteCrackModeIIExact';
